...
class CuentaDragonRow extends Component {
  state = {
  ...
  save = () => {
    fetch(`${BACKEND.ADDRESS}/dragon/actualizar`, {
      method: 'PUT',
  ...
  get SaveButton() {
    return <Button onClick={this.save}>Guardar</Button>;
  }

  get EditButton() {
    return <Button onClick={this.toggleEdit}>Editar</Button>;
  }
...
export default CuentaDragonRow;